      ...
      <div className="bg-primary-50 pb-4 pt-12 sm:pt-0 gap-y-12 flex flex-col sm:block h-[90vh] sm:h-full">
        <div className="w-full sm:h-[65vh] flex flex-col justify-center items-center order-2 sm:order-1">
          ...
          <p className="text-sm sm:text-base lg:text-lg my-8 text-balance text-center w-[90%] xl:w-[60%]">
            Welcome to {" "}
            <span className="text-primary font-calSans">MyFinance</span>, 
            your personal finance management solution designed to simplify your financial journeyWith {" "}
            <span className="text-primary font-calSans">MyFinance</span>, you can effortlessly track expenses, monitor income, and manage your budget—all in one place. 
            Take control of your finances, set achievable goals, and make Financeer financial decisions with ease. 
            Your money, your rules—{" "}
            <span className="text-primary font-calSans">MyFinance</span> is here to help you every step of the way! 🚀💰
          </p>
          <Button
            color="primary"
        ...
        <div className="hidden sm:flex justify-center items-center mt-4">
          <Link
            to="https://github.com/Arshadpinjari/MyFinance"
            target="_blank"
          >
