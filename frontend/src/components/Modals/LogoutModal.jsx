      ...
      <ModalContent>
        <>
          ...
          <ModalBody>
            ...
            Once you log out, your session will end, and you'll need to sign in again to access your account. 
            Don't worry, all your data is safe and secure. 
            Log out only if you're done for now!
            </p>
          </ModalBody>
          <ModalFooter>
            <Button
